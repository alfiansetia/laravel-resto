...
<!-- <link rel="stylesheet" href="{{ asset('plugins/table/datatable/custom_dt_html5.css') }}"> -->
            ...
            <div class="modal-body">
                <form id="form" class="form-vertical" action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control maxlength" id="name" placeholder="Please Enter Name" minlength="3" maxlength="25" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control maxlength" id="email" placeholder="Please Enter Email" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" name="wa" class="form-control maxlength" id="wa" placeholder="Please Enter WA" maxlength="15">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password" class="form-control maxlength" id="password" placeholder="Please Enter Password" minlength="5" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="address" class="form-control maxlength" id="address" placeholder="Please Enter Address" maxlength="150"></textarea>
